        ...
        <div className='mx-auto max-w-3xl overflow-hidden'>
          <div className='px-4 py-5 max-md:px-0'>
            ...
            <p className='mb-6 text-gray-600'>
              ...
              this website or any services provided by Aglint Inc.
            </p>

            <p className='mb-6 text-gray-600'>
              We, Aglint Inc., reserve the right to review and amend any of
            ...
            <ul className='mb-6 list-inside list-disc space-y-2 text-gray-600'>
              ...
              <li>
                ...
                networks or other services provided by Aglint Inc.
              </li>
              <li>
            ...
            <p className='mb-6 text-gray-600'>
              ...
              website is owned by or licensed to Aglint Inc. and is protected by
            ...
            <p className='mb-6 text-gray-600'>
              ...
              intellectual property rights, you grant us a non-exclusive,
            ...
            <p className='mb-6 text-gray-600'>
              ...
              &apos;as is&apos; basis. To the extent permitted by law, Aglint
              Inc. makes no warranties, expressed or implied, and hereby
            ...
            <p className='mb-6 text-gray-600'>
              In no event shall Aglint Inc. or its suppliers be liable for any
              ...
              materials on this website, even if Aglint Inc. or an authorized
            ...
            <p className='mb-6 text-gray-600'>
              ...
              with the laws of California, USA. You irrevocably submit to the
