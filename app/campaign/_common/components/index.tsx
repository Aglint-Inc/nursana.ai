...
export default function FormCampaign() {
  ...
  return (
    <Section>
      <div className='flex h-[calc(100vh-72px)] w-full flex-col items-center gap-8 pt-16'>
        <Form {...form}>
                ...
                <CardContent className='mt-2'>
                  <div className='flex flex-col gap-4'>
                    ...
                    <h1 className='mb-4 text-xl font-medium'>
                      Let Nursana&apos;s AI find your{' '}
                      <span className='text-purple-500'>next opportunity.</span>
                    </h1>
